...
typedef enum { FILTER_EXCLUDE, FILTER_INCLUDE, FILTER_ENSURE } kazoo_filter_type;
...
typedef enum { JSON_NONE, JSON_STRING, JSON_NUMBER, JSON_BOOLEAN, JSON_OBJECT, JSON_RAW } kazoo_json_field_type;
